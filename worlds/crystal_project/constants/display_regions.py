...
CASTLE_RAMPARTS_DISPLAY_SUBREGIONS = [WEST_RAMPARTS_AP_REGION, PEAK_RAMPARTS_AP_REGION, EAST_RAMPARTS_AP_REGION, RAMPART_ATOP_PORTCULLIS_AP_REGION, LONE_CHEST_RAMPART_AP_REGION, RAMPARTS_TALL_TALL_TRAVERSE_AP_REGION]
