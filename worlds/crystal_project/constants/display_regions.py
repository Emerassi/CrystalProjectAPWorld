...
JOJO_SEWERS_DISPLAY_SUBREGIONS = [JOJO_SEWERS_AP_REGION, OMINOUS_RED_SEWERS_AP_REGION, SEWERS_SECRET_PASSWORD_AP_REGION, SEWERS_TO_BOOMER_SOCIETY_AP_REGION]
...
JIDAMBA_EACLANEYA_DISPLAY_SUBREGIONS = [EACLANEYA_ENTRANCE_AP_REGION, EACLANEYA_TRICKY_BLOCK_BRANCHES_AP_REGION, LAND_OF_TIMER_FISHES_AP_REGION, SALMON_ROOM_AP_REGION]
