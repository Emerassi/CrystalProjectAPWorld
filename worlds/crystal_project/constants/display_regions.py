...
DELENDE_DISPLAY_SUBREGIONS = [DELENDE_AP_REGION, GRAN_AP_REGION, BELOW_GRAN_AP_REGION]
...
SALMON_RIVER_DISPLAY_SUBREGIONS = [SALMON_RIVER_AP_REGION, POSEIDON_SHRINE_PROPER_AP_REGION, POSEIDON_SHRINE_ROOF_AP_REGION, RIVER_CATS_EGO_AP_REGION, MUSHROOM_MOUNTAIN_AP_REGION]
...
THE_OPEN_SEA_DISPLAY_SUBREGIONS = [THE_OPEN_SEA_AP_REGION, JIDAMBA_ATOLLS_AP_REGION]
...
LANDS_END_DISPLAY_SUBREGIONS = [LANDS_END_AP_REGION, LANDS_END_NORTHERN_PEAK_AP_REGION]
...
includable_regions: typing.List[str] = [
    ...
    QUINTAR_SANCTUM_DISPLAY_NAME,
    CAPITAL_JAIL_DISPLAY_NAME,
    CAPITAL_PIPELINE_DISPLAY_NAME,
    COBBLESTONE_CRAG_DISPLAY_NAME,
    OKIMOTO_NS_DISPLAY_NAME,
    GREENSHIRE_REPRISE_DISPLAY_NAME,
    SALMON_PASS_DISPLAY_NAME,
    SALMON_RIVER_DISPLAY_NAME,
    SHOUDU_WATERFRONT_DISPLAY_NAME,
    POKO_POKO_DESERT_DISPLAY_NAME,
    SARA_SARA_BAZAAR_DISPLAY_NAME,
    SARA_SARA_BEACH_EAST_DISPLAY_NAME,
    SARA_SARA_BEACH_WEST_DISPLAY_NAME,
    ANCIENT_RESERVOIR_DISPLAY_NAME,
    SALMON_BAY_DISPLAY_NAME,
    THE_OPEN_SEA_DISPLAY_NAME,
    SHOUDU_PROVINCE_DISPLAY_NAME,
    THE_UNDERCITY_DISPLAY_NAME,
    GANYMEDE_SHRINE_DISPLAY_NAME,
    BEAURIOR_VOLCANO_DISPLAY_NAME,
    BEAURIOR_ROCK_DISPLAY_NAME,
    LAKE_DELENDE_DISPLAY_NAME,
    QUINTAR_RESERVE_DISPLAY_NAME,
    DIONE_SHRINE_DISPLAY_NAME,
    QUINTAR_MAUSOLEUM_DISPLAY_NAME,
    EASTERN_CHASM_DISPLAY_NAME,
    TALL_TALL_HEIGHTS_DISPLAY_NAME,
    NORTHERN_CAVE_DISPLAY_NAME,
    LANDS_END_DISPLAY_NAME,
    SLIP_GLIDE_RIDE_DISPLAY_NAME,
    SEQUOIA_ATHENAEUM_DISPLAY_NAME,
    NORTHERN_STRETCH_DISPLAY_NAME,
    CASTLE_RAMPARTS_DISPLAY_NAME,
    THE_CHALICE_OF_TAR_DISPLAY_NAME,
    FLYERS_CRAG_DISPLAY_NAME,
    JIDAMBA_TANGLE_DISPLAY_NAME,
    JIDAMBA_EACLANEYA_DISPLAY_NAME,
    THE_DEEP_SEA_DISPLAY_NAME,
    NEPTUNE_SHRINE_DISPLAY_NAME,
    JADE_CAVERN_DISPLAY_NAME,
    CONTINENTAL_TRAM_DISPLAY_NAME,
    ANCIENT_LABYRINTH_DISPLAY_NAME,
    THE_SEQUOIA_DISPLAY_NAME,
    THE_DEPTHS_DISPLAY_NAME,
    CASTLE_SEQUOIA_DISPLAY_NAME,
    THE_OLD_WORLD_DISPLAY_NAME,
    THE_NEW_WORLD_DISPLAY_NAME,
]