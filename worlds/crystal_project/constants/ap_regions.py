...
HOLE_NEAR_PRIZE_COUNTER_UNDERCITY_CONNECTOR_AP_REGION = "Hole near the Prize Counter connection to Undercity"
BALANCE_BEAM_NEAR_WHITE_HUT_UNDERCITY_CONNECTOR_AP_REGION = "Balance beam above western Undercity in building next to white room"
#Shoudu Province end
...
EAST_UNDERCITY_WALL_CLIMB_AP_REGION = "East Undercity wall climb to the Prize Counter"
